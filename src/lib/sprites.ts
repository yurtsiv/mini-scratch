export const SPRITES = [
  ...
  {
    name: 'Bananas',
    tags: ['food', 'yellow', 'mushy', 'potassium', 'fruit'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Baseball',
    tags: ['baseball', 'sports', 'ball', 'alex eben meyer'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Basketball',
    tags: ['sports', 'basketball', 'alex eben meyer'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Batter',
    tags: ['baseball', 'sports', 'people', 'alex eben meyer'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Beachball',
    tags: ['round', 'sports', 'bounce', 'inflatable'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Beetle',
    tags: ['animals', 'insect', 'bug', 'antennae'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Bell',
    tags: ['music', 'holiday', 'ring', 'things'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Ben',
    tags: ['sports', 'soccer', 'football', 'people', 'alex eben meyer'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Broom',
    tags: ['fantasy', 'ipzy', 'flying', 'things'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Buildings',
    tags: ['things', 'city', 'flying', 'architecture'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Butterfly 1',
    tags: ['animals', 'insect', 'bug', 'wetland', 'owen davey'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Button5',
    tags: ['icons', 'symbols', 'x', 'red', 'black'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Casey',
    tags: ['sports', 'basketball', 'people', 'alex eben meyer'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Cat 2',
    tags: ['cat', 'kitty', 'kitten', 'animals', 'mammal'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Centaur',
    tags: ['fantasy', 'people', 'ipzy', 'emotions'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Chick',
    tags: ['animals', 'chicken', 'farm', 'owen davey'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Clouds',
    tags: ['flying', 'weather', 'things', 'sky'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Convertible 2',
    tags: ['transportation', 'car', 'things'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Dinosaur1',
    tags: ['animals', 'dinosaur', 'alex eben meyer'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Dinosaur2',
    tags: ['animals', 'dinosaur', 'triceratops', 'alex eben meyer'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Dinosaur3',
    tags: ['animals', 'dinosaur', 'pteranodon', 'flying', 'alex eben meyer'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Dinosaur5',
    tags: ['animals', 'dinosaur', 'leigh mcg'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Diver1',
    tags: ['people', 'underwater', 'ocean', 'sea', 'summer', 'swimming'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Dog1',
    tags: ['animals', 'puppy', 'puppies', 'mammals'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Dot',
    tags: ['space', 'dog', 'animals', 'wren mcdonald'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Dragon',
    tags: ['fantasy', 'animals', 'ipzy', 'flying'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Dragonfly',
    tags: ['animals', 'insect', 'dragonfly', 'wetland', 'owen davey'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Drums Conga',
    tags: ['drums', 'drum', 'music', 'instrument', 'percussion'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Duck',
    tags: ['animals', 'chrisg', 'quack', 'birds', 'birb'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Elephant',
    tags: ['animals', 'mammals', 'pachydermata'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Fish',
    tags: ['animals', 'ocean', 'sea', 'underwater', 'daria skrybchencko'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Fishbowl',
    tags: ['fishbowl', 'fish', 'animals', 'pet'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Food Truck',
    tags: ['city', 'truck', 'vehicle', 'food', 'car'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Fox',
    tags: ['animals', 'mammal', 'robert hunter'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Frog',
    tags: ['animals', 'amphibian', 'nature', 'hopping', 'green', 'wart'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Giraffe',
    tags: ['animals', 'savanna', 'robert hunter'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Goalie',
    tags: ['sports', 'soccer', 'football', 'alex eben meyer'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Gobo',
    tags: ['fantasy', 'drawing', 'jenkins', 'ganglia'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Heart',
    tags: ['holiday', 'red', 'shape', 'love', 'emotions'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Hedgehog',
    tags: ['animals', 'daria skrybchencko', 'mammals', 'spikey'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Horse',
    tags: ['animals', 'hoof', 'hooves', 'mammal', 'racing', 'saddle'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Kiran',
    tags: ['space', 'people', 'wren mcdonald'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Ladybug2',
    tags: ['animals', 'insect', 'arthropod', 'antennae', 'aphids'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Lightning',
    tags: ['weather', 'whether', 'fantasy', 'storm', 'thunder'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Lion',
    tags: ['cat', 'animals', 'africa', 'savanna', 'robert hunter'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Mermaid',
    tags: ['fantasy', 'people', 'underwater', 'ipzy'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Milk',
    tags: ['food', 'drink', 'alex eben meyer'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Monkey',
    tags: ['animals', 'mammals', 'primate', 'prehensile tail'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Motorcycle',
    tags: ['city', 'vehicle', 'bike', 'motorcycle'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Owl',
    tags: ['animals', 'bird', 'robert hunter'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Panther',
    tags: ['animals', 'tiger', 'leopard', 'robert hunter'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Penguin 2',
    tags: ['animals', 'bird', 'winter', 'antarctica'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Princess',
    tags: ['fantasy', 'people', 'ipzy', 'castle', 'emotions'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Radio',
    tags: ['radio', 'music', 'beatbox', 'bedrorom'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Rainbow',
    tags: ['things', 'flying', 'drawing', 'color'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Robot',
    tags: ['space', 'robot', 'wren mcdonald'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Rocketship',
    tags: ['space', 'spaceship', 'wren mcdonald'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Shark',
    tags: ['animals', 'underwater', 'ipzy', 'fish'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Shark 2',
    tags: ['animals', 'ocean', 'sea', 'fish', 'teeth', 'carnivore', 'chomp'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Shoes',
    tags: ['fashion', 'shoes', 'sneakers', 'clothing'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Shorts',
    tags: ['fashion', 'pants', 'shorts', 'clothing'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Snake',
    tags: ['animals', 'reptile', 'robert hunter'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Speaker',
    tags: ['music', 'things', 'bass', 'treble', 'concert'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Starfish',
    tags: ['animals', 'echinodermata', 'underwater', 'sea', 'ocean'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Strawberry',
    tags: ['food', 'fruit', 'alex eben meyer'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Sun',
    tags: ['space', 'star', 'hydrogen', 'helium', 'fusion', 'nuclear'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Unicorn 2',
    tags: ['fantasy', 'animals', 'horse', 'horn', 'rainbow'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  },
  {
    ...
    tags: ['fantasy', 'animals', 'ipzy', 'walking'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Watermelon',
    tags: ['food', 'fruit', 'summer', 'seeds', 'seedless', 'plants'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Winter Hat',
    tags: ['fashion', ' clothing', 'winter', 'hat'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Witch',
    tags: ['fantasy', 'people', 'ipzy', 'castle', 'emotions', 'magic'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Wizard Girl',
    tags: ['people', 'female', 'girl', 'wizard', 'magic', 'fantasy'],
    isStage: false,
    variables: {},
    costumes: [
      {
  ...
  {
    name: 'Zebra',
    tags: ['animals', 'zebra', 'savanna', 'robert hunter'],
    isStage: false,
    variables: {},
    costumes: [
      {
